%Change the value of this variable to the path of your song file
file='../data/classical/cls (9)'

%%
%You may need to to change the path to the template data
load('Feature Extraction\Musical Surface Features\song_data__centroid.mat')
load('Feature Extraction\Musical Surface Features\song_data__flux.mat')
load('Feature Extraction\Musical Surface Features\song_data__rolloff.mat')
load('Feature Extraction\Musical Surface Features\song_data__zerocrossing.mat')
load('Feature Extraction\Musical Surface Features\song_data_mazumdarzcr.mat')
%% 
...
%Load up functions from another path
addpath('Feature Extraction\Musical Surface Features');
...
%remove loaded paths
rmpath('Feature Extraction\Musical Surface Features');
rmpath('Feature Extraction\')
