...
ZeroCrossing_country=zeros(1,length(country));
for index=1:1:length(country),
    ...
    ZeroCrossing_country(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_rnb=zeros(1,length(rnb));
for index=1:1:length(rnb),
    ...
    ZeroCrossing_rnb(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_rap=zeros(1,length(rap));
for index=1:1:length(rap),
    ...
    ZeroCrossing_rap(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_rock=zeros(1,length(rock));
for index=1:1:length(rock),
    ...
    ZeroCrossing_rock(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_blues=zeros(1,length(blues));
for index=1:1:length(blues),
    ...
    ZeroCrossing_blues(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_jazz=zeros(1,length(jazz));
for index=1:1:length(jazz),
    ...
    ZeroCrossing_jazz(index)=ZeroCrossing(S,F,T);
end

ZeroCrossing_classical=zeros(1,length(classical));
for index=1:1:length(classical),
    ...
    ZeroCrossing_classical(index)=ZeroCrossing(S,F,T);
end